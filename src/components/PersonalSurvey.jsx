...
const supabase = createClient("https://aqvtfsfnhtdviffdwkyz.supabase.co", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImFxdnRmc2ZuaHRkdmlmZmR3a3l6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDAwMjk3MTAsImV4cCI6MjA1NTYwNTcxMH0.smDWB8S5nugK9owKzD_SowdNvEUs03nnsbLkLMndC5s");
...
const PersonalSurvey = () => {
  const [formData, setFormData] = useState({
    ...
    // New work-focused questions (for those who answer "Yes" to workInterest)
    professionalGoals: '', // Q10
    workType: '',          // Q11
    otherWorkType: '',     // If "Other" is chosen
    experienceYears: '',   // Q12
    workTools: [],         // Q13 (multiple choice)
    otherWorkTool: '',     // If "Other" is chosen for Q13
    workToolsLacking: '',  // Q14
    workFactors: [],       // Q15 (multiple choice)
    otherWorkFactor: '',   // If "Other" is chosen for Q15
    workHelpRanking: [     // Q16 (ranked choice)
    ...
    workCompetitiveEdge: '', // Q17
    // contactPreference: '',    // Q18
    numberOfEmployees: '', // New state variable for number of employees
    personalInterest: '',
  });

  // Determine which section is final.
  // If workInterest is "Yes", we add 9 additional sections (8–16),
  // otherwise, the survey ends at section 7.
  const finalSection = formData.workInterest === 'Yes' ? 16 : 7;
  ...
  // Function to validate if the current section's required fields are filled
  const validateCurrentSection = () => {
    switch (currentSection) {
      ...
      case 7:
        return formData.workInterest;
      case 8:
        return true; // No input required for this section
      case 9:
  ...
  const nextSection = () => {
    if (validateCurrentSection() && currentSection < finalSection) {
  ...
  const handleSubmit = async (e) => {
    ...
    const submissionData = {
      ...
      work_interest: formData.workInterest || "Not submitted",
      industry: formData.industry || "Not submitted",
      ...
      personal_interest: formData.personalInterest || "Used Personal entry point",
  ...
  const renderSection = () => {
    if (showConfirmation) {
      return <div>Your responses have been recorded, and you're now on the waitlist for Kairos Personal! 
        <br></br>
        <br></br>
    ...
    switch (currentSection) {
          ...
          <section className="w-full max-w-md mx-auto">
            ...
            <label>
              ...
              <span className="tooltip-container">
                &#9432;
                <span className="tooltip">
                  This could be new experiences, personal projects, career changes, travel, spending time with friends, or anything else that brings you joy!
                </span>
              </span>
              <input
                type="text"
      ...
      case 2:
        return (
          <section>
            <h2>Challenges</h2>
            <label>
              <strong>What is keeping you from achieving these goals? *</strong>
              <span className="tooltip-container">
                &#9432;
                <span className="tooltip">
      ...
      case 3:
        return (
          <section>
            ...
            <label>
              <strong>How do you stay organized? *</strong>
              {[
                "Apple Notes",
                "Google Keep/Drive",
                "Notion",
            ...
            <label>
              <strong>What do you find lacking in these tools? *</strong>
              <span className="tooltip-container">
                &#9432;
                <span className="tooltip">
      ...
      case 4:
        return (
          <section>
            <h2>Tool Features</h2>
            <label>
              <strong>What aspects of your current tools do you love the most? *</strong>
              <input
                type="text"
                name="toolFeatures"
      ...
      case 5:
        return (
          <section>
            <h2>Motivation</h2>
            <label>
              <strong>What helps you stay motivated to achieve your goals? *</strong>
              <input
                type="text"
                name="motivation"
      ...
      case 6:
        return (
          <section>
            <h2>Goals</h2>
            <label>
              <strong>Which of these would you most like to achieve in the next year? (Drag and drop to reorder) *</strong>
            </label>
            <RankedChoice
      ...
      case 7:
        return (
          <section>
            <h2>Work Interest</h2>
            <label>
              <strong>Would you also be interested in using Kairos for work? *</strong>
              <span className="tooltip-container">
                &#9432;
                <span className="tooltip">
                  Kairos isn't just for personal organization—it can also help you stay ahead of the curve in your professional life.
                </span>
              </span>
              <select name="workInterest" value={formData.workInterest} onChange={handleChange}>
                <option value="">Select an option</option>
                <option value="Yes">Yes, I'm also interested in using Kairos for work.</option>
                <option value="No">No, I'm only interested in personal use.</option>
              </select>
            </label>
          </section>
        );
      case 8:
        return (
          <section>
            <h2><strong>You're on the Kairos Personal waitlist!</strong></h2>
            <p>Your responses have been submitted, and you're officially <strong>on the waitlist</strong> for Kairos personal. You're officially one step closer to achieving your loftiest goals! 
            <br></br>
            <br></br>
            Now, let's see if Kairos can help you move just as fast in your professional life. This section will help us assess if you're a good fit for <strong>early access</strong> to Kairos Professional.</p>
          </section>
        );
      case 9:
        return (
      ...
      case 14:
        return (
          <section>
            ...
            <label>
              <strong>What are the most important factors in choosing an organizational tool for your work? (Select up to 3) *</strong>
              {[
      ...
      case 15:
        return (
          <section>
            ...
            <label>
              <strong>What would you like Kairos to help you with the most? (Drag and drop to reorder) *</strong>
            </label>
            <RankedChoice
  ...
  // Determine whether the current section is the last one.
